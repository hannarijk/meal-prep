...
// =============================================================================
// GENERATE SHOPPING LIST TESTS
// =============================================================================

func TestIngredientService_GenerateShoppingList_Success(t *testing.T) {
	setup := setupIngredientServiceTest()
	request := testdata.NewShoppingListRequestBuilder().WithRecipeIDs([]int{1, 2}).Build()
	...
	result, err := setup.service.GenerateShoppingList(request)
...
func TestIngredientService_GenerateShoppingList_EmptyRecipeList(t *testing.T) {
	setup := setupIngredientServiceTest()
	request := testdata.NewShoppingListRequestBuilder().WithNoRecipes().Build()
...
func TestIngredientService_GenerateShoppingList_DifferentUnits(t *testing.T) {
	setup := setupIngredientServiceTest()
	request := testdata.NewShoppingListRequestBuilder().WithRecipeIDs([]int{1, 2}).Build()
