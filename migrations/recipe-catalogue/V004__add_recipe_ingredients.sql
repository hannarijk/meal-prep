...
(
    ...
    ingredient_id INTEGER                             NOT NULL REFERENCES recipe_catalogue.ingredients (id),
...
FROM (VALUES
          ...
          (4, 12, 0.50, 'teaspoon', 'to taste')) AS sample_data(recipe_id, ingredient_id, quantity, unit, notes)
